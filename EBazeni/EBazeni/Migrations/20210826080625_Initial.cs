        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prebivaliste = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Boraviste = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaksimalanBrojKorisnika = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoviUlaznica", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "TipoviZaposlenika",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoviZaposlenika", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Zaposlenici_TipoviZaposlenika_TipZaposlenikaId",
                        column: x => x.TipZaposlenikaId,
                        principalTable: "TipoviZaposlenika",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KorisnikUsesUlaznica_ApplicationUserId",
                table: "KorisnikUsesUlaznica",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_KorisnikUsesUlaznica_UlaznicaId",
                table: "KorisnikUsesUlaznica",
                column: "UlaznicaId");

            migrationBuilder.CreateIndex(
                name: "IX_Ulaznice_TipUlazniceId",
                table: "Ulaznice",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Zaposlenici_TipZaposlenikaId",
                table: "Zaposlenici",
